          ...
          <tbody className="divide-y divide-slate-50">
            {history.map((h, i) => (
              <tr key={i} className="hover:bg-slate-50">
                <td className="py-2.5 font-semibold text-slate-800 text-xs">{h.skill}</td>
                <td className="py-2.5 text-slate-500 text-xs">{h.skill_exp} yrs</td>
                <td className="py-2.5 text-slate-500 text-xs">{h.designation || '—'}</td>
