        ...
        {loading ? (
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {benchEmployees.map(emp => (
              <div key={emp.employee_id} className="group rounded-2xl border border-violet-100 bg-white p-5 shadow-[0_20px_60px_-30px_rgba(15,23,42,0.2)] transition duration-200 hover:-translate-y-1 hover:border-violet-300 hover:shadow-[0_20px_45px_-25px_rgba(99,102,241,0.45)]">
